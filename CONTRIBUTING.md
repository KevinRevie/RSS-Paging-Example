# Contributing to RSS-Paging-Example
...
Please read the following guidelines before you [report an issue](https://github.com/kevinrevie/RSS-Paging-Example/issues):
...
**[File a bug report](https://github.com/kevinrevie/RSS-Paging-Example/issues)**
...
2. Clone your fork (`git clone
   https://github.com/<your-username>/RSS-Paging-Example.git`).

3. Add an `upstream` remote (`git remote add upstream
   https://github.com/kevinrevie/RSS-Paging-Example.git`).
